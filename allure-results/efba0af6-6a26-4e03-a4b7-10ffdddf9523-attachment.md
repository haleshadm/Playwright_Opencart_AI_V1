...
- Name: web\data-driven-login.spec.ts >> Data Driven Login - Valid login (pavanol@xyz.com) - row 1 @master @datadriven @web
        ...
        - generic [ref=f1e87]:
          ...
          - generic [ref=f1e91]:
            - generic [ref=f1e92]:
              ...
              - textbox "E-Mail Address" [ref=f1e94]: pavanol@xyz.com
            - generic [ref=f1e95]:
              - generic [ref=f1e96]: Password
              - textbox "Password" [ref=f1e97]: test@123
